...
function Logger:Debug(...)
   if self.mia.db.profile.debugEnabled then
      ...
      if self.isPratLoaded then
         ...
         prefix = self.mia.chalk:debug("[DEBUG] ")
            .. self.mia.chalk:ace("(" .. tostring(date()) .. ")")
      end
...
function Logger:DebugClickInfo(
   bagIndex,
   bagName,
   button,
   down,
   ...
   self:Debug(
      "HANDLE ON CLICK INFO:\n"
         ...
         .. "————————————————————————\n"
         .. "SlotFrameName = "
         .. tostring(slotFrame:GetName())
         .. "\n"
         .. "SlotFrameID = "
         .. tostring(slotFrame:GetID())
         .. "\n"
         .. "————————————————————————\n"
         .. "FrameName = "
         ...
         .. tostring(item:GetItemLocation().slotIndex)
         .. "\n"
         .. "————————————————————————"
   )
end
...
function Logger:PrintSaleSummary(totalSellPrice, totalItemsSold, uniqueItemsSold, itemLinksList)
   local summaryOutput = self.mia.chalk:money("$$$$$ SALE SUMMARY $$$$$")
      .. "\n"
      .. self.mia.chalk:money("Total Money Made: ")
      .. tostring(self.mia.utils:PriceToGold(totalSellPrice))
      .. "\n"
      .. self.mia.chalk:money("Total Unique Items Sold: ")
      .. tostring(uniqueItemsSold)
      .. "\n"
      .. self.mia.chalk:money("Total Items Count Sold: ")
      .. tostring(totalItemsSold)
      .. "\n"
